...
def get_args():
    ...
    parser.add_argument('--s3_path', default=' ', type=str)
    ...
    parser.add_argument('--return_full', default=True, type=bool,
                        help='ratio of the visual tokens/patches need be masked')
    ...
    # Dataset parameters
    parser.add_argument('--data_path', default='/cache/imagenet/train', type=str,
                        help='dataset path')
